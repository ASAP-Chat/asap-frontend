  <template>
    <div class="tw-leading-normal tw-tracking-normal tw-text-white gradient">
      <LayoutNav />
      <div data-aos="fade-up" class="tw-pt-28">
        <div
          ...
          <div class="tw-w-full md:tw-w-3/5 tw-py-6 tw-text-center">
            <img class="tw-w-full md:tw-w-3/5 tw-z-50" :src="heroSrc" />
          </div>
        </div>
      </div>
      ...
      <section id="chat" class="tw-bg-white tw-border-b tw-py-14">
        <div class="container tw-max-w-5xl tw-mx-auto tw-m-8">
          <h2 data-aos="fade-up"
      ...
      <section id="chatbot" class="tw-bg-white tw-border-b tw-py-16">
      ...
      <section id="chattemplate" class="tw-bg-white tw-border-b tw-py-16">
        <div class="container tw-max-w-5xl tw-mx-auto m-8">
          <h2 data-aos="fade-up"
            class="tw-w-full tw-my-2 tw-text-5xl tw-font-bold tw-leading-tight tw-text-center tw-text-gray-800">
            แชตเทมเพลต
      ...
      <section id="teammanagement" class="tw-bg-white tw-border-b tw-py-16">
        <div class="container tw-max-w-5xl tw-mx-auto m-8">
          <h2 data-aos="fade-up"
            class="tw-w-full tw-my-2 tw-text-5xl tw-font-bold tw-leading-tight tw-text-center tw-text-gray-800">
            ระบบจัดการทีม
      ...
      <section id="about" data-aos="zoom-in-up" class="tw-container tw-mx-auto tw-text-center tw-py-6">
        ...
        <div data-aos="fade-up-left" class="tw-flex tw-w-full">
          <div class="tw-w-full tw-flex tw-justify-around">
            <div class="tw-flex tw-flex-col tw-space-y-10 tw-items-center">
              <img src="../assets/images/memberphai.jpg" alt="member"
                class="tw-w-72 tw-h-72 tw-rounded-full tw-justify-center tw-drop-shadow-xl tw-shadow-md">
              <div class="tw-flex tw-flex-col tw-leading-9">
                <span class="tw-text-[30px] tw-font-bold">63130500055</span>
                <span class="tw-text-[25px] tw-font-extralight">ธราเทพ ศิริพิศ</span>
              </div>
            </div>
            <div class="tw-flex tw-flex-col tw-space-y-10 tw-items-center">
              <img src="../assets/images/memberpleng.jpg" alt="member"
                class="tw-w-72 tw-h-72 tw-rounded-full tw-justify-center tw-drop-shadow-xl tw-shadow-md">
              <div class="tw-flex tw-flex-col tw-leading-9">
                <span class="tw-text-[30px] tw-font-bold">63130500056</span>
                <span class="tw-text-[25px] tw-font-extralight">ธัญกร แถลงดี</span>
              </div>
            </div>
            <div class="tw-flex tw-flex-col tw-space-y-10 tw-items-center">
              <img src="../assets/images/memberdear.jpg" alt="member"
                class="tw-w-72 tw-h-72 tw-rounded-full tw-justify-center tw-drop-shadow-xl tw-shadow-md">
              <div class="tw-flex tw-flex-col tw-leading-9">
                <span class="tw-text-[30px] tw-font-bold">63130500064</span>
                <span class="tw-text-[25px] tw-font-extralight">นภัสวรรณ บุตรวัตร</span>
              </div>
            </div>
          </div>
        </div>
        <div class="tw-mt-5 tw-text-[25px] tw-font-bold tw-text-gray-700">Advised by Dr. Sunisa Sathapornvajana</div>
      </section>
    </div>
  </template>
