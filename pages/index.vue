<template>
  <div class="tw-leading-normal tw-tracking-normal tw-text-white gradient">
        ...
        <div data-aos="fade-up-right" class="tw-flex tw-flex-wrap tw-justify-center">
          <div class="tw-w-5/6 sm:tw-w-1/2 tw-p-6 tw-flex tw-justify-center tw-items-center">
            <div class="tw-text-[20px] tw-text-gray-800 tw-mb-2 tw-leading-6">
              จัดการแชทผ่านเว็บไซต์ LINE OA, Facebook messenger และ Instagram ในที่เดียว <br />
    ...
    <section id="contact" data-aos="zoom-in-up" class="tw-container tw-mx-auto tw-text-center tw-py-6">
      ...
      <div data-aos="fade-up-left" class="tw-flex tw-flex-wrap">
        <div class="sm:tw-w-1/3 tw-p-6 tw-flex">
      ...
      <!-- <h3 class="tw-my-4 tw-text-3xl tw-leading-tight">คลิกที่นี่!!</h3> -->
      <!-- <button
