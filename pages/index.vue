<template>
  <div class="tw-leading-normal tw-tracking-normal tw-text-white gradient">
    ...
    <section
      id="chat"
      class="tw-bg-white tw-border-b tw-py-14"
    >
      <div class="container tw-max-w-5xl tw-mx-auto tw-m-8">
        ...
        >
          <div
            class="tw-h-1 tw-mx-auto tw-bg-primary tw-w-64 tw-opacity-25 tw-my-0 tw-py-0 tw-rounded-t"
          ></div>
        </div>
        <div
    ...
    <section
      id="chatbot"
      class="tw-bg-white tw-border-b tw-py-16"
    >
      <div class="container tw-max-w-5xl tw-mx-auto m-8">
        ...
        >
          ...
          <div
            class="tw-w-5/6 sm:tw-w-1/2 tw-p-6 tw-flex tw-flex-col tw-justify-center tw-items-center"
          >
            <div class="tw-text-[20px] tw-text-gray-800 tw-mb-2 tw-leading-6">
    ...
    >
      <div class="container tw-max-w-5xl tw-mx-auto m-8">
        ...
        >
          ...
          <div class="tw-w-full sm:tw-w-1/2 tw-p-6 tw-flex tw-justify-center tw-items-center">
            <img
              src="../assets/images/chattemplate.svg"
              alt="chat"
              class="tw-w-full tw-rounded-lg tw-drop-shadow-xl tw-shadow-md"
            />
          </div>
    ...
    <section
      id="about"
      data-aos="zoom-in-up"
      class="tw-container tw-mx-auto tw-text-center tw-py-6"
    >
      <h2
      ...
      <div class="tw-w-full tw-mb-12">
        <div
          class="tw-h-1 tw-mx-auto tw-bg-primary tw-w-1/6 tw-opacity-25 tw-my-0 tw-py-0 tw-rounded-t"
        ></div>
      </div>
      <div
        data-aos="fade-up-left"
      ...
      >
        <div class="tw-w-full tw-flex tw-justify-around">
          <div class="tw-flex tw-flex-col tw-space-y-10 tw-items-center">
            <img
              src="../assets/images/memberphai.jpg"
              alt="member"
          ...
          <div class="tw-flex tw-flex-col tw-space-y-10 tw-items-center">
            <img
              src="../assets/images/memberpleng.jpg"
              alt="member"
              class="tw-w-72 tw-h-72 tw-rounded-full tw-justify-center tw-drop-shadow-xl tw-shadow-md"
            />
            <div class="tw-flex tw-flex-col tw-leading-9">
          ...
          <div class="tw-flex tw-flex-col tw-space-y-10 tw-items-center">
            <img
              src="../assets/images/memberdear.jpg"
              alt="member"
              class="tw-w-72 tw-h-72 tw-rounded-full tw-justify-center tw-drop-shadow-xl tw-shadow-md"
            />
            <div class="tw-flex tw-flex-col tw-leading-9">
